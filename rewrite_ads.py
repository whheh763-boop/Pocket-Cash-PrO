...
object AdsManager {
    ...
    private fun loadAdMobRewarded(context: Context) {
        ...
        RewardedAd.load(context, currentRewardedId, adRequest, object : RewardedAdLoadCallback() {
    ...
    fun loadAppOpenAd(context: Context) {
        ...
        AppOpenAd.load(context, currentAppOpenId, request, AppOpenAd.APP_OPEN_AD_ORIENTATION_PORTRAIT, object : AppOpenAd.AppOpenAdLoadCallback() {
